  ...
  <body>
    ...
    <div class = "jumbotron jumbotron-fluid text-white text-center m-0 bgCol" >
      ...
      <div class = "container-fluid  m-0 p-0">
        <div class = "row m-0 p-0" >
          <div class = "col-md-12 col-lg-4 col-sm-12 p-0 m-0 ">
            <div class = "card text-center border-0 rounded-0">
              <img class = "card-img rounded-0" src="../Images/HRInteraction.jpg" alt = "Card image">
        ...
        <div class = "col-md-12 col-lg-4 col-sm-12 p-0 m-0">
          <div class = "card text-center border-0 rounded-0">
            <img class = "card-img  rounded-0" src="../Images/ComplexSystems.jpg" alt = "Card image">
            <div class = "card-img-overlay">
              <div class = "row justify-content-center" style = "height:80%">
      ...
      <div class = "col-md-12 col-lg-4 col-sm-12 p-0 m-0">
        <div class = "card text-center border-0 rounded-0">
          <img class = "card-img rounded-0" src="../Images/HumanPerformance.jpg" alt = "Card image">
          <div class = "card-img-overlay">
            <div class = "row justify-content-center" style = "height:80%">
